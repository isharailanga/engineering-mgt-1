...
class HelloWorld extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if(this.state.selected_ProductVersion !== prevState.selected_ProductVersion) {
            ...
            let infoPerf = {  infoVersion , issueType : 'perf-report' }
            ...
            let infoSecScan = {  infoVersion , issueType : 'sec-scan' }
            ...
            let infoCommitment = { infoVersion, issueType : 'commitment' }
            jiraUrl = hostUrl + '/jiraIssues/' + this.state.selectedProductName;
            ...
            let infoSecCust = {  infoVersion, issueType : 'sec-cust' }
            jiraUrl = hostUrl + '/jiraIssues/' + this.state.selectedProductName;
            ...
            let infoSecExt = { infoVersion, issueType : 'sec-ext' }
            jiraUrl = hostUrl + '/jiraIssues/' + this.state.selectedProductName;
            ...
            let infoSecInt = {  infoVersion, issueType : 'sec-int' }
            jiraUrl = hostUrl + '/jiraIssues/' + this.state.selectedProductName;
